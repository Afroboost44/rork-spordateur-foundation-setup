...
async function seed() {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    const images = [
      PROFILE_IMAGES[i],
      `https://images.unsplash.com/photo-${1517836357463 + i * 100000}?w=800&q=80&auto=format&fit=crop`,
      `https://images.unsplash.com/photo-${1534438327276 + i * 100000}?w=800&q=80&auto=format&fit=crop`,
    ];
